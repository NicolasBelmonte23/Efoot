...
class FindClubServiceTest {
    ...
    void shouldFindAllClubsWithPagination() {
        ...
        when(clubMapper.toClubResponse(club1)).thenReturn(clubResponse1);
        when(clubMapper.toClubResponse(club2)).thenReturn(clubResponse2);
        ...
        verify(clubMapper, times(2)).toClubResponse(any(Club.class));
    }
